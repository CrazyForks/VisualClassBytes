 ...
 * from the specification file <tt>vcb.flex</tt>
 */
class VCBLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return VCBTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return VCBTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return VCBTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
